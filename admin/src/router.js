...
// Admin (o'qituvchi) sayti — faqat "teacher" roli
  ...
  routes: [
    ...
    { path: "/login", component: () => import("@shared/views/Login.vue"), meta: { guest: true } },
    {
      ...
      children: [
        ...
        { path: "lessons/:id/topics",  component: () => import("./views/Topics.vue") },
        ...
        { path: "ai-logs",             component: () => import("./views/AILogs.vue") },
...
router.beforeEach(createRoleGuard("teacher"));
