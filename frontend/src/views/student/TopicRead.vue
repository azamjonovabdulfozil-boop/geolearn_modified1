    ...
    <template v-else-if="topic">
      <article class="reader geo-card">
        ...
        <nav class="reader-nav">
          ...
          <RouterLink v-else :to="`/student/topics/${topic.id}/test?mode=open`"
      ...
      <div class="bottom-actions">
        <RouterLink :to="`/student/topics/${topic.id}/test?mode=open`" class="bottom-card">
          <ListChecks :size="20" />
          <div>
        ...
        <RouterLink :to="`/student/topics/${topic.id}/test?mode=closed`" class="bottom-card">
          <PenLine :size="20" />
          <div>
